			...
			<table style="margin-left: 100px;">
				<tbody>
					<tr>
						...
						<td>
							<input type="text" id="username" name="username" class="text" maxlength="20" readonly="readonly">
						</td>
					...
					<tr>
						...
						<td>
							<input type="password" id="password" name="password" class="text" maxlength="20" autocomplete="off" disabled="disabled">
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" id="email" name="email" class="text" maxlength="200" disabled="disabled">
						</td>
					</tr>
					<tr>
						<th><br>
					...
					<tr>
						...
						<td>
							<span class="fieldSet">
														<label>
															<input type="radio" name="memberAttribute_2" value="male" disabled="disabled">男
														</label>
														<label>
															<input type="radio" name="memberAttribute_2" value="female" disabled="disabled">女
														</label>
												</span>
						</td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" name="memberAttribute_3" class="text" onfocus="WdatePicker();" disabled="disabled">
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="memberAttribute_5" class="text" maxlength="200" disabled="disabled">
						</td>
					</tr>
					<tr>
