...
<html>
    ...
    <style>
		body
		{
			SCROLLBAR-ARROW-COLOR: #ffffff;  SCROLLBAR-BASE-COLOR: #bbbbbb	;
		}
    </style>
  </head>
<frameset rows="135px,*,30px" frameborder=0 border="0" framespacing="0">
  <frame src="${pageContext.request.contextPath}/admin/top.jsp" name="topFrame" scrolling="NO" noresize>
  <frameset cols="190px,*" frameborder="0" border="0" framespacing="0">
