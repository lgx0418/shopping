...
<HTML>
	...
	<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminCategory_save.action" method="post">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="lightgoldenrodyellow" style="border: 1px solid #8ba7e3" border="0">
				<tr>
				...
				<tr>
					<td width="18%" align="center" bgColor="white" class="ta_01">
						一级分类名称：
					</td>
